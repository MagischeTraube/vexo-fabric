	...
	override fun onInitializeClient() {
		...
		ClientCommandRegistrationCallback.EVENT.register { dispatcher, _ ->
			arrayOf(
				...
				TyfrCommand, reInviteCommand, KuudraStatsCommand, deezNutsCommand,
				...
				t1Command, t2Command, t3Command, t4Command, t5Command
			).forEach { commodore -> commodore.register(dispatcher) }
		}

		arrayOf(
			DungeonUtils, PartyUtils, TyfrTrigger, DungeonDevTest, HelpOfTheFairysUtils
